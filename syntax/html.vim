...
syn match   htmlAssign   contained "="
syn region  htmlEndTag             start=+</+      end=+>+ contains=htmlTagN,htmlTagError
syn region  htmlTag                start=+<[^/]+   end=+>+ fold contains=htmlAssign,htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,htmlCssDefinition,@htmlPreproc,@htmlArgCluster
...
if !exists("html_no_rendering")
  ...
  if !exists("html_my_rendering")
    ...
    " Breaks stuff - don't highlight italics -JB 4/12/18
    hi def htmlItalic              None
