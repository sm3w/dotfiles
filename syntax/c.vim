...
syn keyword cImportant  IMPORTANT

" Jamie's custom types
" Integers
...
syn cluster	cCommentGroup	contains=cTodo,cBadContinuation,cNote,cImportant
...
syn keyword	cStorageClass	static register auto volatile extern const typedef
if exists("c_gnu")
