...
syn match   pythonComment	"#.*$" display contains=pythonTodo,pythonNote,pythonImportant,@Spell
...
if s:Python2Syntax()
  ...
  syn region pythonDocString start=+^\s*"""+ end=+"""+ keepend contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,pythonDocTest2,pythonSpaceError,pythonTodo,pythonNote,pythonImportant,@Spell
endif
