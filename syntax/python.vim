...
" We have set some of tbe below options to zero for things we don't want
" highlighted. Equals operator, etc -JB 26/9/18
...
"call s:Python3SyntaxDefault('g:python3syntax_highlight_equal_operator',0)

" Highlight '*' operator
"call s:Python3SyntaxDefault('g:python3syntax_highlight_stars_operator', g:python3syntax_all)
"call s:Python3SyntaxDefault('g:python3syntax_highlight_stars_operator', 0)

" Highlight 'self' keyword
"call s:Python3SyntaxDefault('g:python3syntax_highlight_self', g:python3syntax_all)
"call s:Python3SyntaxDefault('g:python3syntax_highlight_self', 0)
...
call s:Python3SyntaxDefault('g:python3syntax_builtin_objs', 1)
...
" True and False in custom keyword 'Constant'
    syn keyword pythonConstant  True False 
...
"    These seem to cause significant lag in vim 8.1. Removing for now, not sure
"    what they do - JB 26/9/18
"
...
" Removed 'True' and 'False' from builtin objects
