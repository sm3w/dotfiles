...
syn match   pythonComment	"#.*$" contains=pythonTodo,pythonNote,pythonImportant,@Spell
"syn region pythonDocString	start=+^\s*"""+ end=+"""+ keepend contains=pythonTodo,pythonNote,pythonImportant
syn region  Comment		start=/"""/ end=/"""/ contains=pythonTodo,pythonNote,pythonImportant,@Spell
